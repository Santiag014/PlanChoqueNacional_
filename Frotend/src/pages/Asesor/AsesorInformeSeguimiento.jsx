    ...
    <DashboardLayout user={user} pageTitle="INFORME SEGUIMIENTO">
      <div style={{
        ...
        <div style={{
          ...
          <div 
            onClick={() => handleButtonClick('/asesor/registro-galonaje')}
            style={{
              width: '100%',
              maxWidth: '350px',
              background: '#fff',
          ...
          >
            ...
            <p style={{
              ...
              Registrar volumen de ventas y precios de productos participantes
            </p>
          </div>

          {/* Botón 2: Ver Visitas/Implementación */}
          <div 
            onClick={() => handleButtonClick('/asesor/registro-visitas')}
            style={{
              width: '100%',
              maxWidth: '350px',
              background: '#fff',
          ...
          >
            ...
            <h3 style={{
              ...
              REGISTRAR VISITAS/IMPLEMENTACIÓN
            </h3>
            <p style={{
              color: '#666',
              fontSize: '14px',
              ...
              Registrar visitas de seguimiento a PDVs / implementaciones PDVs
            </p>
          </div>
          ...
          >
            ...
            <p style={{
              ...
              Ver y gestionar todos los registros históricos
            </p>
          </div>
        </div>
      </div>
