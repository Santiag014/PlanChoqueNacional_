...
import '../../styles/Asesor/asesor-ranking.css';
...
// Importar el hook del ranking
import { useRankingAsesor } from '../../hooks/asesor';
...
const catalogos = [
  {
    ...
    imagen: planpdvImg,
    pdfUrl: '/storage/catalogos/Catalogo_Plan_PDV.pdf'
  },
  {
    id: 2,
    titulo: 'CATÁLOGO OILTEC',
    imagen: oiltecImg,
    pdfUrl: '/storage/catalogos/Catalogo_Oiltec.pdf'
  },
  {
    id: 3,
    titulo: 'CATÁLOGO CELERITY',
    imagen: celerityImg,
    pdfUrl: '/storage/catalogos/Catalogo_Celerity.pdf'
  }
];
