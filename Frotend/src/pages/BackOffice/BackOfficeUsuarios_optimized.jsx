...
export default function BackOfficeUsuarios() {
  ...
  // OPTIMIZACIÓN: Memoizar estadísticas filtradas
    ...
    <DashboardLayout>
      <div className="backoffice-visitas-container">
        ...
        <div className="backoffice-stats-summary">
          ...
          <div className="backoffice-stat-card">
            <div className="backoffice-stat-value">{estadisticasFiltradas.activos}</div>
            <div className="backoffice-stat-label">Activos</div>
          </div>
          <div className="backoffice-stat-card">
            <div className="backoffice-stat-value">{estadisticasFiltradas.inactivos}</div>
            <div className="backoffice-stat-label">Inactivos</div>
          </div>
          {!loading && (
            <div className="backoffice-stat-card" style={{ backgroundColor: '#e8f5e8' }}>
              <div className="backoffice-stat-value">⚡</div>
              <div className="backoffice-stat-label">Optimizado</div>
            </div>
          )}
        </div>
